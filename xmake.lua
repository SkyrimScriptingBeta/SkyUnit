...
add_requires("SkyrimScripting.Messages", { configs = { commonlib = get_config("commonlib") } })
add_requires("catch2", "nlohmann_json")

includes("xmake/*.lua")
includes("skyunit/xmake.lua")
includes("skyunit-runner/xmake.lua")
